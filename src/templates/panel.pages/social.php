                    ...
                    <table class="table table-striped table-hover border">
                        <thead class="bg-dark text-light">
                            <tr>
                                ...
                                <th class="d-none d-md-table-cell text-center text-md-left" scope="col">Icono</th>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="validationServer01" placeholder="Nombre.." name="social_nombre" required>
                                <div class="invalid-feedback">
                                    Escribe el nombre de al red social!
                                </div>
                            </div>

                            <div class="col-md-6">
                                <label for="validationServer02" class="form-label">Url</label>
                                <input type="text" class="form-control" id="validationServer02" placeholder="Url.." name="social_url" required>
                                <div class="invalid-feedback">
                                    Ingrese el URL de la red social!
                                </div>
                            </div>

                            <div class="col-md-6">
                                <label for="validationServer03" class="form-label">Icono</label>
                                <input type="text" class="form-control" id="validationServer03" placeholder="Icono.." name="social_icon" required>
                                <div class="invalid-feedback">
                                    Ingrese un icono de fontawesome!
                                </div>
                            </div>

                            <div class="col-md-6">
                                <label for="validationServer04" class="form-label">Color</label>
                                <input type="color" class="form-control" id="validationServer04" placeholder="Color.." name="social_color" required>
                                <div class="invalid-feedback">
                                    Selecciona el color de tu red social!
                                </div>
                            </div>
